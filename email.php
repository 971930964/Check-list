...
$mail->SMTPSecure = 'tls';
$mail->IsSMTP();
$mail->Username = "cesargatto@gmail.com"; // your GMail user name
$mail->Password = "magrelo85"; 
$mail->AddAddress('checklistgeneral@gmail.com'); // recipients email 
$mail->FromName = "cesargatto"; // readable name
$mail->IsHTML(true);
$mail->Subject = "title";
$mail->Body    = " Message"; 
$mail->SMTPDebug = 4; 
